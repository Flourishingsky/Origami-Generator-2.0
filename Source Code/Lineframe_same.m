function [] = Lineframe_same(facet,hs,s,dxf)
...
%     plot3(2*hs-[facet1_x(3),facet1_x(2)],[facet1_y(3),facet1_y(2)],[facet1_z(3),facet1_z(2)],'r','Linewidth',1);hold on;
    ...
    if dxf == 1
        ...
        dxf_polyline(FID_M,[facet1_x(4),facet1_x(3)]',[facet1_y(4),facet1_y(3)]',[facet1_z(4),facet1_z(3)]');
        dxf_polyline(FID_M,[facet1_x(3),facet1_x(2)]',[facet1_y(3),facet1_y(2)]',[facet1_z(3),facet1_z(2)]');
        dxf_polyline(FID_M,[facet1_x(2),facet1_x(1)]',[facet1_y(2),facet1_y(1)]',[facet1_z(2),facet1_z(1)]');

%         dxf_polyline(FID_V,2*hs-[facet1_x(1),facet1_x(4)]',[facet1_y(1),facet1_y(4)]',[facet1_z(1),facet1_z(4)]');
        dxf_polyline(FID_M,2*hs-[facet1_x(4),facet1_x(3)]',[facet1_y(4),facet1_y(3)]',[facet1_z(4),facet1_z(3)]');
%         dxf_polyline(FID_M,2*hs-[facet1_x(3),facet1_x(2)]',[facet1_y(3),facet1_y(2)]',[facet1_z(3),facet1_z(2)]');
        dxf_polyline(FID_M,2*hs-[facet1_x(2),facet1_x(1)]',[facet1_y(2),facet1_y(1)]',[facet1_z(2),facet1_z(1)]');
